        ...
        saveBtn.setOnAction(actionEvent -> {
            ...
            try {
                customer.setAll(
                        ...
                        Miscellaneous.getValueFromNumericTextBox(telTxtFld.getValue()),
                        Miscellaneous.getValueFromNumericTextBox(cellphoneTxtFld.getValue()),
                        Miscellaneous.getValueFromNumericTextBox(faxTxtFld.getValue()),
                        ...
                        Miscellaneous.getValueFromNumericTextBox(companyNumTxtFld.getValue()),
